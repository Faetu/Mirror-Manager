...
Parser.add_argument(
    "-l",
    "--list-of-available-countrys",
    help="show a list of available countrys",
    action="store_true",
)
Parser.add_argument(
    "-u",
    "--update",
    help="update mirrorlist based on the existing countrys, protocols and ip version",
    action="store_true",
)
Parser.add_argument(
    "-w",
...
if __name__ == "__main__":
    with open("Available_Countries.json", "r") as f:
        CDate = json.load(f)
        for c in CDate:
